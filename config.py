...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " 𓆩ғʟᴇx ᴍᴜsɪᴄ𓆪")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ttccss/FlexMusicBot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/XTIORY")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/G_SEZR")
